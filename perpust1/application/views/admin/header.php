  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('admin/index'); ?>">
        ...
        <div class="sidebar-brand-text mx-3" style="font-family: 'Roboto Slab', serif;">E-Perpus<sup></sup></div>
      </a>
    ...
    <?php $uriMethod_name=$this->router->fetch_method(); ?>
      ...
      <li <?php 
       ...
       <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse" aria-expanded="true" aria-controls="collapse">
        ...
        <div id="collapse" class="collapse buku" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-success py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo base_url().'admin/buku' ?>"><i class="fas fa-book"></i>   Data Buku</a>
            <a class="collapse-item" href="<?php echo base_url().'admin/kategori' ?>"><i class="fas fa-bookmark"></i>   Jenis Buku</a>
            <a class="collapse-item" href="<?php echo base_url().'admin/tambah_buku' ?>"><i class="fas fa-plus"></i>   Tambah Buku Baru</a>
      </li>
      ...
      <li <?php 
        ...
        <div id="collapsee" class="collapse anggota" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-success py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo base_url().'admin/anggota' ?>"><i class="fas fa-users"></i>   Data Anggota</a>
            <a class="collapse-item" href="<?php echo base_url().'admin/tambah_anggota' ?>"><i class="fas fa-user-plus"></i>   Tambah Anggota Baru</a>  
      </li>
...
<h6 class="mx-auto pt-4 d-none d-lg-inline text-white"><?php $d=date('l , d/m/Y'); echo "$d"; ?>  &nbsp;</h6>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-white" style="font-family: 'Roboto Slab', serif; font-size: 15px;">  <?php echo "ADMIN".$this->session->userdata('name');?></span>
