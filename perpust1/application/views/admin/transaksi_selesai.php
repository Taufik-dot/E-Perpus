...
<option <?php
if($p->id_anggota==$k->id_anggota){echo "selected='selected'";} ?> value="<?php echo
...
<option <?php
if($p->id_buku==$m->id_buku){echo "selected='selected'";} ?> value="<?php echo
$m->id_buku; ?>"><?php echo
$m->judul_buku; ?></option>
<?php } ?>
</select>
...
<input class="form-control" type="date" name="tgl_pinjam" value="<?php echo
